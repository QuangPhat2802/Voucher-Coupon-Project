	...
	<div class="search">
		...
		<div class="brand-item">
			<ul class="sb_dropdown"  >
				...
				<a class="hidden-item d-none" >Hidden</a>              
			</ul>			
		</div>
	</div>
		<table class="table table-bordered table-hover" id="productInfoTable">
			<thead>
				<tr class="text-center">
					...
					<th scope="col" style="width: 120px">Sale Date</th>
					<th scope="col" style="width: 120px">Brand Name</th>
			...
			<div class="modal-content">
				<form id="productInfoForm" role="form" enctype="multipart/form-data">
					...
					<div class="modal-footer modal-add">
						...
						<div class="loading" id="divMessage">
							<p class="cssld">
							<span class="cssspan">
								<span class="dot"></span>
								<span class="dot"></span>
	...
	<!--  modal delete -->
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Do you want to delete <b id="product-name"></b>?</p>
				</div>
